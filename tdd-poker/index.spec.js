...
describe("comparePokerHands", () => {
  describe("When both hands has same rank", () => {
    it("should return 0", () => {
      ...
      // expect(comparePokerHands("TS JS QS KS AS", "TH JH QH KH AH")).toBe(0);
    });
  });
  ...
  describe("When first hand has higher rank", () => {
    it("should return 1", () => {
      ...
      // tie-breakers
      // expect(comparePokerHands("AS AH 2H 2S 2D", "KS KH 3H 3S 3D")).toBe(1);
      // expect(comparePokerHands("TS TH TH 2S 2D", "7S 7H 7H AS AD")).toBe(1);
    });
  });
